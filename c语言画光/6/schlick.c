...
int main() {
	for(n = 0; n < 4; n++){
		...
		if(n == 1){
			svpng(fopen("schlick01.png", "wb"), W, H, img, 0);
		} else if(n == 2){
			svpng(fopen("schlick02.png", "wb"), W, H, img, 0);
		} else if(n == 3){
			svpng(fopen("schlick03.png", "wb"), W, H, img, 0);
		} else {
			svpng(fopen("schlick00.png", "wb"), W, H, img, 0);
		}
	}
}
